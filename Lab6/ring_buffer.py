...
class RingBuffer:
    ...
    def replace(own,loc,newData):
        """
        Replace a data at the specific Position in the RingBuffer
        :param own: slef object
        :param newData: Data to be Replace
...
def test():
        ...
        list1.print()
        print("Testing Replace : .replace(0,4444)")
        list1.replace(0,4444)
        list1.print()
        #data=
